...
function App() {
  ...
  return (
    <div className="App mt-3 bg-gray-700">
      <Navbar/>
      <div className="mx-auto p-6 pt-0 sm:max-w-5xl">
        ...
        <div className="mt-2 sm:flex sm:gap-2">
          <div className="flex flex-col items-center rounded-md border-b-4 border-pink-400 bg-gray-500 p-6 text-center">
          ...
          <div className="mt-2 flex flex-col items-center rounded-md border-b-4 border-pink-400 bg-gray-500 p-6 text-center sm:mt-0">
            <div className="rounded-full bg-gray-300 p-3">
              <svg
                className="h-12 w-12 fill-current"
                xmlns="http://www.w3.org/2000/svg"
